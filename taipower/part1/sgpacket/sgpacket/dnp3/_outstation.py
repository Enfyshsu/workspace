#ref: https://github.com/ChargePoint/pydnp3/blob/master/examples/outstation.py
...
class Outstation(opendnp3.IOutstationApplication):
    """
    ...
    def __init__(self, log_levels, local_ip, port):
        super(Outstation, self).__init__()
        ...
        Outstation.set_outstation(self.outstation)
    ...
    def apply_update(self, value, index):
        ...
        Outstation.get_outstation().Apply(update)
...
class OutstationCommandHandler(opendnp3.ICommandHandler):
    ...
    def Select(self, command, index):
        ...
        """
        Outstation.process_point_value('Select', command, index, None)
    ...
    def Operate(self, command, index, op_type):
        ...
        :return: CommandStatus
        """
        Outstation.process_point_value('Operate', command, index, op_type)
        return opendnp3.CommandStatus.SUCCESS
